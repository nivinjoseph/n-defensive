...
class EnsurerInternal {
    ...
    ensureIsInstanceOf(type, when) {
        ...
        if (!(this._arg instanceof type))
            throw new ArgumentException(this._argName, `must be instance of ${type.getTypeName()}`);
        return this;
    }
    ensureHasStructure(structure, when) {
        ...
        try {
            ...
            throw new InvalidArgumentException(this._argName, error);
        }
        if (!result) {
        ...
        for (const key in schema) {
            ...
            if (typeof typeInfo === "function") {
                if (!(value instanceof typeInfo))
                    throw new ArgumentException(this._argName, `invalid value of type '${value.getTypeName()}' for property '${fullName}' of type '${typeInfo.getTypeName()}'`);
                continue;
            }
            if (Array.isArray(typeInfo)) {
                if (!Array.isArray(value))
                    throw new ArgumentException(this._argName, `invalid value of type '${typeof value}' for property '${fullName}' of type 'array'`);
                if (typeInfo.isEmpty)
                    continue;
            ...
            if (typeof typeInfo === "object") {
                if (typeof value !== "object")
                    throw new ArgumentException(this._argName, `invalid value of type '${value.getTypeName()}' for property '${fullName}' of type '{}'`);
